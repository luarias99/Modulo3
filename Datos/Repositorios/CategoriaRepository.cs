    ...
    public  class CategoriaRepository : ICategoriaRepository
    {
        ...
        public async Task<bool> ActualizarAsync(Categoria categoria)
        {
            ...
            try
            {
                ...
                sql.Append(" UPDATE categoria SET Nombre = @Nombre,  EstadoActivo = @EstadoActivo ");
        ...
        public async Task<bool> NuevaAsync(Categoria categoria)
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append(" INSERT INTO categoria (Codigo, Nombre, EstadoActivo) ");
                sql.Append(" VALUES (@Codigo, @Nombre, @EstadoActivo) ");
