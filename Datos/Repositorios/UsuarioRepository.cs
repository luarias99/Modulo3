...
namespace Datos.Repositorios
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        /*Implementar las interfaces o metodos*/
        ...
        public async Task<bool> ActualizarAsync(Usuario usuario)
        {
            ...
            try
            {
                ...
                sql.Append(" Foto = @Foto, Rol = @Rol, EstadoActivo = @EstadoActivo ");
        ...
        public async Task<bool> NuevoAsync(Usuario usuario)
        {
            ...
            try
            {
                ...
                StringBuilder sql = new StringBuilder();
                sql.Append(" INSERT INTO usuario (Codigo, Nombre, Correo, Clave, Foto, Rol, EstadoActivo) ");
                sql.Append(" VALUES (@Codigo, @Nombre, @Correo, @Clave, @Foto, @Rol, @EstadoActivo) ");
